return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>a", group = "AI 补全", icon = { icon = "󰚩", color = "purple" } }, -- group: AI / minuet (nf-md-robot U+F06A9)
            ...
            { "<leader>m", group = "Markdown 渲染", icon = { icon = "", color = "blue" } }, -- group: Markdown (U+E609)
            ...
            { "<leader>ac", icon = "" }, -- Minuet choice preset (cod-list_selection U+EB85)
            { "<leader>af", icon = "" }, -- Minuet fast preset (cod-dashboard U+EACE)
            { "<leader>at", icon = "" }, -- Minuet 补全开关 (cod-sync U+EB92)
            ...
            { "<leader>md", icon = "" }, -- Markdown 渲染关闭 (cod-circle_slash U+EAC0)
            { "<leader>me", icon = "" }, -- Markdown 渲染开启 (cod-eye U+EA70)
            { "<leader>mm", icon = "" }, -- Markdown 渲染开关 (cod-sync U+EB92)
